  ...
  <body>
    ...
    echo "
                    ...
                    <div class='select-option1'>
                        ...
                        <option value='list_order.php?id1=ASC&id2=" . $name . "&id3=" . $id . "'>ASC</option>
                        <option value='list_order.php?id1=DESC&id2=" . $name . "&id3=" . $id . "'>DESC</option>
                    ...
                    <span class='order'><h4>GROUP BY DISEASE</h4></span>
                    
                        <select name='orderr' class='select adj' onchange='location=this.value;'>
                        <option value='' selected> SELECT ..</option>
                        <option value='list_group.php?id2=ON&id3=" . $name . "&id4=" . $id . "'>ON</option>
                        <option value='list1.php?&do_id=" . $id . "&do_name=" . $name . "'>OFF</option>
                       </select>
...
inner join `hospital`.`doctor` on `doctor`.`d_name`=`info`.`appoint` WHERE `doctor`.`d_id`='$d_id';";

          // $con->query($sql1);
          //   $sql2=" SELECT * from `hospital`.dfs ;";
    ...
    <div class="main" id="tables">
      ...
      <table id="table2" cellspacing="0">
        ...
        //create index index_name_id on doctor (d_id,d_name);

        $sql = " SELECT `info`.* , year(CURDATE())- year(`info`.`dob`) as age from `hospital`.`info` inner join 
          `hospital`.`doctor` on `doctor`.`d_name`=`info`.`appoint` AND `doctor`.`d_id`='$id';";
    ...
    <td class='name1'>
        <p  name='p_name' class='input_tag' required  >" . $result['p_name'] . "</p>
   ...
   <tr class='row dd'>
    ...
    <td class='name1'>
    <p  name='p_name' class='input_tag' required  >" . $result['address'] . "</p>
   ...
   <tr class='row dd'>
    ...
    <td class='name1'>
    <p  name='p_name' class='input_tag' >" . $result['appoint'] . "</p>
   ...
   <tr class='row dd'>
    ...
    <td class='name1'>
    <p  name='p_name' class='input_tag' required >" . $result['disease'] . "</p>
   ...
   <tr class='row dd'>
    ...
    <td class='name1'>
    <p  name='p_name' class='input_tag' >" . $result['dob'] . "</p>
   ...
   <tr class='row dd'>
    ...
    <td class='name1'>
    <p  name='p_name' class='input_tag' required  >" . $result['mobile_no'] . "</p>
   ...
   <tr class='row dd'>
    ...
    <td class='name1'>
    <p  name='p_name' class='input_tag' required  >" . $result['email'] . "</p>
   ...
   <tr class='row dd'>
    ...
    <td class='name1'>
    <p  name='p_name' class='input_tag' required  >" . $result['textarea'] . "</p>
